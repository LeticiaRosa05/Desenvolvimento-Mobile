                                ...
                                child: ListView(
                                  ...
                                  children: [
                                    MouseRegion(
                                      ...
                                      onEnter: ((event) async {
                                        safeSetState(
                                            () => _model.userHovered = true);
                                      }),
                                      onExit: ((event) async {
                                        safeSetState(
                                            () => _model.userHovered = false);
                                      }),
                                    ),
                                  ],
                                ),
                              ...
                              child: Align(
                                ...
                                child: StreamBuilder<List<UsersRecord>>(
                                  ...
                                  builder: (context, snapshot) {
                                    ...
                                    List<UsersRecord>
                                        mouseRegionUsersRecordList =
                                        snapshot.data!;
                                    // Return an empty Container when the item does not exist.
                                    if (snapshot.data!.isEmpty) {
                                      return Container();
                                    }
                                    final mouseRegionUsersRecord =
                                        mouseRegionUsersRecordList.isNotEmpty
                                            ? mouseRegionUsersRecordList.first
                                            : null;
