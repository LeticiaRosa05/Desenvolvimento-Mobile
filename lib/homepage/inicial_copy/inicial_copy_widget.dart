...
import 'inicial_copy_model.dart';
export 'inicial_copy_model.dart';

class InicialCopyWidget extends StatefulWidget {
  const InicialCopyWidget({
    super.key,
    this.listasAdiciona,
  ...
  static String routeName = 'inicialCopy';
  static String routePath = '/inicialCopy';

  @override
  State<InicialCopyWidget> createState() => _InicialCopyWidgetState();
}

class _InicialCopyWidgetState extends State<InicialCopyWidget> {
  late InicialCopyModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => InicialCopyModel());
  ...
  Widget build(BuildContext context) {
    ...
    return StreamBuilder<List<ListsRecord>>(
      ...
      builder: (context, snapshot) {
        ...
        List<ListsRecord> inicialCopyListsRecordList = snapshot.data!;
                ...
                child: Column(
                  ...
                  children: [
                      ...
                      child: TextFormField(
                        ...
                        onFieldSubmitted: (_) async {
                          if (_model.textController1.text != '') {
                            ...
                            _model.resultadoPesq = _model.simpleSearchResults2
                                .map((e) => e.reference)
                                .toList()
                        ...
                        decoration: InputDecoration(
                          hintText: FFLocalizations.of(context).getText(
                            'g37u5040' /* Procure em suas listas... */,
                          ),
                    ...
                    StickyHeader(
                                          ...
                                          decoration: InputDecoration(
                                            hintText:
                                                FFLocalizations.of(context)
                                                    .getText(
                                              '9hljdu7r' /* Procure em suas listas... */,
                                            ),
                                            enabledBorder: InputBorder.none,
                                            focusedBorder: InputBorder.none,
                                            errorBorder: InputBorder.none,
                      ...
                      content: Visibility(
                        visible: !FFAppState().pesqListasInicial,
                        child: Column(
                          mainAxisSize: MainAxisSize.max,
                          children: [
                            if (inicialCopyListsRecordList.isNotEmpty)
                              Align(
                                alignment: AlignmentDirectional(-1.0, 0.0),
                                child: Padding(
                                  padding: EdgeInsetsDirectional.fromSTEB(
                              ...
                              Padding(
                                ...
                                child: Container(
                                  ...
                                  child:
                                      ...
                                      Visibility(
                                    visible:
                                        inicialCopyListsRecordList.isNotEmpty,
                                    child: Padding(
                                      padding: EdgeInsetsDirectional.fromSTEB(
                                          10.0, 10.0, 10.0, 10.0),
                                                                    ...
                                                                    children: [
                                                                      ...
                                                                      Align(
                                                                        ...
                                                                        child:
                                                                          ...
                                                                          onPressed:
                                                                              () async {
                                                                            await listViewMarcadasListsRecord.reference.update(createListsRecordData(
                                                                              marked: false,
                                                                            ));
                                                                          },
                                                                        ),
                        ...
                        children: [
                          ...
                          Align(
                            ...
                            child: Padding(
                              ...
                              child: Text(
                                FFLocalizations.of(context).getText(
                                  '4ubwixfu' /* Listas que tenho acesso */,
                                ),
                                style: FlutterFlowTheme.of(context)
                                    .labelMedium
                                    .override(
