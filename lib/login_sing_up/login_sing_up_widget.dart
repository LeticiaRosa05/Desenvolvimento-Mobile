...
import 'login_sing_up_model.dart';
export 'login_sing_up_model.dart';

class LoginSingUpWidget extends StatefulWidget {
  const LoginSingUpWidget({super.key});

  static String routeName = 'LoginSingUp';
  static String routePath = '/loginSingUp';

  @override
  State<LoginSingUpWidget> createState() => _LoginSingUpWidgetState();
}

class _LoginSingUpWidgetState extends State<LoginSingUpWidget>
    with TickerProviderStateMixin {
  late LoginSingUpModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => LoginSingUpModel());
